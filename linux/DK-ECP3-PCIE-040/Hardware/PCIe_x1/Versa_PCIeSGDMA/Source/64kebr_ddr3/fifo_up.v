...
/* Module Version: 5.4 */
/* C:\lscc\diamond\1.1\ispfpga\bin\nt\scuba.exe -w -lang verilog -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 16 -width 64 -depth 16 -rdata_width 64 -no_enable -pe -1 -pf -1 -e  */
/* Thu Apr 21 13:20:59 2011 */
...
module fifo_up (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, Q, 
    ...
    PDPW16KC pdp_ram_0_0_1 (.DI0(Data[0]), .DI1(Data[1]), .DI2(Data[2]), 
        ...
        .ADW0(wptr_0), .ADW1(wptr_1), .ADW2(wptr_2), .ADW3(wptr_3), .ADW4(scuba_vlo), 
        ...
        .ADR7(rptr_2), .ADR8(rptr_3), .ADR9(scuba_vlo), .ADR10(scuba_vlo), 
    ...
    PDPW16KC pdp_ram_0_1_0 (.DI0(Data[36]), .DI1(Data[37]), .DI2(Data[38]), 
        ...
        .ADR6(rptr_1), .ADR7(rptr_2), .ADR8(rptr_3), .ADR9(scuba_vlo), .ADR10(scuba_vlo), 
        .ADR11(scuba_vlo), .ADR12(scuba_vlo), .ADR13(scuba_vlo), .CER(rden_i), 
        .CLKR(RdClock), .CSR0(scuba_vlo), .CSR1(scuba_vlo), .CSR2(scuba_vlo), 
        .RST(Reset), .DO0(Q[54]), .DO1(Q[55]), .DO2(Q[56]), .DO3(Q[57]), 
        .DO4(Q[58]), .DO5(Q[59]), .DO6(Q[60]), .DO7(Q[61]), .DO8(Q[62]), 
        .DO9(Q[63]), .DO10(), .DO11(), .DO12(), .DO13(), .DO14(), .DO15(), 
        .DO16(), .DO17(), .DO18(Q[36]), .DO19(Q[37]), .DO20(Q[38]), .DO21(Q[39]), 
