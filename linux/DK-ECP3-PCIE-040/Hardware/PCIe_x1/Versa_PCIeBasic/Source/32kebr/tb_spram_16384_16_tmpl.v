//Verilog testbench template generated by SCUBA ispLever_v8.1_PROD_Build (20)
`timescale 1 ns / 1 ps
module tb;
    reg Clock = 0;
    reg ClockEn = 0;
    ...
    spram_16384_16 u1 (.Clock(Clock), .ClockEn(ClockEn), .Reset(Reset), 
        .ByteEn(ByteEn), .WE(WE), .Address(Address), .Data(Data), .Q(Q)
    );
