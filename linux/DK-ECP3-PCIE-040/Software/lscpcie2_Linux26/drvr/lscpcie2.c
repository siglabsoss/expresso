		  ...
		  unsigned long arg)
{
	...
	if (DrvrDebug)
		printk(KERN_INFO "lscpcie2: ioctl(minor=%d cmd=%d arg=%lx size=%d)\n", 
 ...
 */
static int __init lscpcie2_probe(struct pci_dev *pdev,
 ...
 */ 
static void __devexit lscpcie2_remove(struct pci_dev *pdev)
{
