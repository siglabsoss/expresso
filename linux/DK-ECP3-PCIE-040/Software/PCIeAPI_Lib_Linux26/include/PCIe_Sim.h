...
#ifndef LATTICE_SEMI_PCIE_PCIE_SIM_H
#define LATTICE_SEMI_PCIE_PCIE_SIM_H
 ...
 *
 */
class DLLIMPORT PCIe_Sim  : public LatticeSemi_PCIe::PCIe_IF
{
public:


    PCIe_Sim(LatticeSemi_PCIe::SimDemoIP *pDemo, uint8_t *pCFG0 = NULL, const PCIResourceInfo_t *pDrvrInfo=NULL);
    ~PCIe_Sim();
