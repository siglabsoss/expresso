...
/* Module Version: 5.4 */
/* C:\lscc\diamond\2.2_x64\ispfpga\bin\nt64\scuba.exe -w -n adc_pll -lang verilog -synth synplify -arch ep5c00 -type pll -fin 100 -phase_cntl STATIC -fclkop 100 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -bw -e  */
/* Tue Nov 19 00:02:15 2013 */


`timescale 1 ns / 1 ps
module adc_pll (CLK, CLKOP, LOCK)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute adc_pll dont_touch true 
    input wire CLK;
    output wire CLKOP;
    output wire LOCK;
